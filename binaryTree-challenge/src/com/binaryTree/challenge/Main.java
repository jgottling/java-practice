...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      allMyNodes.forEach((key, value) -> System.out.println("Key: " + key + ", Value: " + value));

      tree = new BinaryTree(allMyNodes.get(linksList[0].charAt(1)));
    ...
    if (tree != null) endExecution(tree.toString());
  }
  ...
  private static void checkCycles(HashMap<Character, MyNode> allMyNodes, BinaryTree tree)
      throws Exception {
